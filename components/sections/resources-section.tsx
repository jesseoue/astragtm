...
const resources = [
  ...
  {
    type: "Guide",
    title: "The Complete SaaS GTM Playbook",
    description: "140-page comprehensive guide covering every aspect of SaaS go-to-market strategy from lead generation to revenue optimization.",
    category: "Free Download",
    readTime: "PDF Guide",
    date: "Dec 10, 2024",
    image: "/placeholder.jpg",
    slug: "/resources/saas-gtm-playbook",
    icon: Download,
    featured: true
  },
  {
    type: "Blog Post",
    title: "AI-Powered Lead Scoring: 5 Strategies That Work",
    description: "Learn how to implement AI-driven lead scoring systems that identify your highest-value prospects automatically.",
    category: "AI & Automation",
    readTime: "6 min read",
    date: "Dec 8, 2024",
    image: "/placeholder.jpg",
    slug: "/blog/ai-lead-scoring-strategies",
    icon: BookOpen
  },
  {
    type: "Webinar",
    title: "Live: Scaling B2B SaaS to $10M ARR",
    description: "Join our CEO for a live session on the exact strategies we used to help 50+ SaaS companies reach $10M ARR.",
    category: "Live Training",
    readTime: "60 min",
    date: "Dec 20, 2024",
    image: "/placeholder.jpg",
    slug: "/webinars/scaling-saas-10m-arr",
    icon: Video
  },
  {
    type: "Podcast",
    title: "Revenue Growth Secrets with Top SaaS CEOs",
    description: "Weekly interviews with successful SaaS founders sharing their growth tactics and revenue optimization secrets.",
  ...
  {
    type: "Template",
    title: "GTM Strategy Canvas Template",
    description: "Free Figma template to map out your complete go-to-market strategy. Used by 1000+ SaaS companies.",
    category: "Free Template",
    readTime: "Figma File",
    date: "Dec 5, 2024",
    image: "/placeholder.jpg",
    slug: "/templates/gtm-strategy-canvas",
    icon: FileText
  }
]
